...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/CatalogApp/CatalogApp/fb_client_secrets.json', 'r')
                        .read())['web']['app_id']
    app_secret = json.loads(open('/var/www/CatalogApp/CatalogApp/fb_client_secrets.json', 'r')
                            .read())['web']['app_secret']
...
def gconnect():
    ...
    print("obtaining id_token...")
    idToken = request.data

    print("Code: " + idToken)

    print("sending req to tokeninfo...")
    ...
    gplus_id = result['sub']
    print("verifying aud matches clientID...")
    ...
    if "name" in result:
        ...
        login_session['username'] = result['email']
